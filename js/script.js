document.addEventListener('DOMContentLoaded', () => {
	...
	$('.anchor-link').on('click', function (e) {
		...
		const offset = 80; // Ajusta esto si tu header tiene altura fija
    ...
    spaceBetween: 0,
    autoHeight: true,
    loop: true, // importante para que vuelva al inicio
    autoplay: {
        delay: 3000, // 3 segundos entre cada slide
        disableOnInteraction: false // sigue aunque el usuario haga clic o pase con el mouse
    },
    navigation: {
